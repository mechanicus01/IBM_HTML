...
// display employees details based on department such as the HR department     
...
// Find employee by ID and display their details
...
// Function to display employees by specialization Javascript
function jsEmployee(specialty) { // remember too call this function in the HTML file
      const foundEmployee = employees.find(employee => employee.specialization === specialty);
      if (foundEmployee) {
